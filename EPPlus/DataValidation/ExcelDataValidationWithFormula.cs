...
namespace OfficeOpenXml.DataValidation
{
        ...
        where T : IExcelDataValidationFormula
    {
        ...
        public override void Validate()
        {
            ...
            if (ValidationType != ExcelDataValidationType.List && ValidationType != ExcelDataValidationType.Custom && (Operator == ExcelDataValidationOperator.between || Operator == ExcelDataValidationOperator.notBetween))
            {
